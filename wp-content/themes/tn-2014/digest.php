			...
			<h3><a href="<?php bloginfo('url'); ?>/nyheter/">Siste nyheter</a></h3>
				...
				?>
					...
					<article id="post-<?php the_ID(); ?>" <?php neuf_post_class(); ?>>
						...
						<div class="entry-meta byline"><span class="entry-date"><?php echo date_i18n( get_option('date_format'), get_post_time('U', true) ).", ".date_i18n( get_option('time_format'), get_post_time('U', true) ); ?></span></div>
